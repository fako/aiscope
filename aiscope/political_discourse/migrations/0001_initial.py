# Generated by Django 4.2.8 on 2024-01-10 08:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='political_discourse.collection')),
                ('dataset_version', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='political_discourse.datasetversion')),
            ],
            options={
                'ordering': ['id'],
                'get_latest_by': 'id',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='political_discourse.datasetversion'),
        ),
    ]
